...
void ggml_cuda_mul_mat_q(
    ...
    if (!ids) {
        ...
        // Use persistent buffer instead of pool allocation for CUDA graph compatibility
        void * src1_q8_1_ptr = ctx.mmq_get_src1_q8_1(nbytes_src1_q8_1);
    ...
    // Use persistent buffers instead of pool allocations for CUDA graph compatibility
    int32_t * ids_src1_ptr      = (int32_t *) ctx.mmq_get_ids_src1(ne_get_rows * sizeof(int32_t));
    int32_t * ids_dst_ptr       = (int32_t *) ctx.mmq_get_ids_dst(ne_get_rows * sizeof(int32_t));
    int32_t * expert_bounds_ptr = (int32_t *) ctx.mmq_get_expert_bounds((ne02 + 1) * sizeof(int32_t));

    {
        ...
        ggml_cuda_launch_mm_ids_helper((const int32_t *) ids->data, ids_src1_ptr, ids_dst_ptr, expert_bounds_ptr,
    ...
    const size_t nbytes_src1_q8_1 = ne12*n_expert_used*ne10_padded * sizeof(block_q8_1)/QK8_1 +
        get_mmq_x_max_host(cc)*sizeof(block_q8_1_mmq);
    // Use persistent buffer for src1_q8_1 as well
    void * src1_q8_1_ptr = ctx.mmq_get_src1_q8_1(nbytes_src1_q8_1);
...

    {
        ...
        if (use_native_mxfp4) {
            quantize_mmq_mxfp4_cuda(src1_d, ids_src1_ptr, src1_q8_1_ptr, src0->type, ne10, s11, s12, s13,
                                    ne10_padded, ne11_flat, ne12_flat, ne13_flat, stream);
        } else {
            quantize_mmq_q8_1_cuda(src1_d, ids_src1_ptr, src1_q8_1_ptr, src0->type, ne10, s11, s12, s13,
                                   ne10_padded, ne11_flat, ne12_flat, ne13_flat, stream);
        }
        CUDA_CHECK(cudaGetLastError());
    }
    ...
    const mmq_args args = {
        src0_d, src0->type, (const int *) src1_q8_1_ptr, ids_dst_ptr, expert_bounds_ptr, dst_d,
